...
__global__ void matrixMultiplyShared_restrict(const float * __restrict__ A, const float * __restrict__ B, float * __restrict__ C,
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K)
{
    ...
    matrixMultiplyShared_restrict<<<gridDim_matmul, blockDim_matmul>>>(device_mask, unrolled_matrix, matmul_output, 
                                                            A_row, A_col,
